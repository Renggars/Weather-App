...
function App() {
  ...
  useEffect(() => {
    fetch(
      `https://api.openweathermap.org/data/2.5/weather?q=${term}&appid=84fabc793d50575486666bb93545d6f6&units=metric`
    )
      .then((res) => res.json())
    ...
    <div className="flex h-screen justify-center items-center">
      ...
      >
        ...
        <div className="mt-10 p-4 relative rounded-full flex justify-between">
          ...
          <div className="flex z-10 text-white gap-3 text-[20px]">
